    ...
    <>
      ...
      <section className="py-20 sm:py-28">
        <Reveal className="container-page mx-auto max-w-2xl text-center">
          <Image
            src="/images/illustrations/footer-CTA1-cropped.png"
            alt="Illustration of a NutriPath candidate studying at a desk with a laptop, notebook, and coffee, with notes reading 'Mock Exam Progress 8/10 completed' and 'Confidence is up, you're ready'"
            width={923}
            height={669}
            className="mx-auto h-auto w-full max-w-lg"
          />
          <h2 className="mt-8 font-heading text-3xl font-bold text-charcoal sm:text-4xl">
            Build your confidence, one mock exam at a time.
          </h2>
          <p className="mx-auto mt-4 max-w-md font-body text-lg text-mid">
            Track your progress as you study, practice, and get ready for
            exam day.
          </p>
          <div className="mt-8 flex justify-center">
